...
![argo-workflow-gif](/img/guides/package-manager/argo-workflow.gif)
...
![package-repo-structure](/img/guides/package-manager/package-repo-structure.png)
...
![argo-workflows-on-glasskube](/img/guides/package-manager/argo-workflows-on-glasskube.png)
