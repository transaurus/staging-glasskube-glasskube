...
A useful characteristic of Kustomize is that from [Kubectl](https://distr.sh/glossary/kubernetes/#kubectl) version 1.14, Kustomize is integrated into the Kubectl cli tool, meaning that no additional installations are needed.
