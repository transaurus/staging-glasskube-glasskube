...
[Glasskube](https://github.com/glasskube/glasskube) is a Kubernetes package manager that extends and complements Helm in multiple ways, supporting multiple package formats, including Helm charts and plain YAML files. Glasskube addresses several of Helm’s limitations, providing enhanced functionality such as:
