...
:::info
Kubernetes package management refers to the process of managing, deploying, and maintaining [Kubernetes](https://distr.sh/glossary/kubernetes/) applications using package managers, which simplify the handling of complex resources across multiple environments.
:::

Package managers like [Helm](/glossary/helm) and [Glasskube](https://github.com/glasskube/glasskube) enable developers and operators to bundle Kubernetes resources together into reusable, shareable packages. These tools help to standardize application deployments, reduce the chance of misconfigurations, and speed up the entire process of rolling out Kubernetes applications.
